...
class Compilation extends Tapable {
	...
	addChunkInGroup(name, module, loc) {
		if(name) {
			if(Object.prototype.hasOwnProperty.call(this.namedChunkGroups, name)) {
				const chunk = this.namedChunkGroups[name];
				if(module) {
